You are working as a computer scientist in a laboratory seeking to sequence the genome. A DNA sequence is represented by a character string (of  A, C, T and G) such as GATTACA.
...
​
So if, for example, you have three sub-sequences AGATTA, GATTACA, and TACAGA you should be able to find the sequence AGATTACAGA which has the property of containing all of these.
agattacaga
